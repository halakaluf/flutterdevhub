...
import 'package:flutterdevhub/piano_tiles/line.dart';
import 'package:flutterdevhub/piano_tiles/line_divider.dart';
import 'package:flutterdevhub/piano_tiles/note.dart';
import 'package:flutterdevhub/piano_tiles/song_provider.dart';
...
class _MainPageState extends State<MainPage>
  ...
  Widget build(BuildContext context) {
    return Material(
      child: Stack(
        ...
        children: <Widget>[
          Image.asset(
            'lib/piano_tiles/assets/background.jpg',
            fit: BoxFit.cover,
          ),
          Row(
            children: <Widget>[
  ...
  _playNote(Note note) {
    switch (note.line) {
      case 0:
        player.play('../lib/piano_tiles/assets/a.wav');
        return;
      case 1:
        player.play('../lib/piano_tiles/assets/c.wav');
        return;
      case 2:
        player.play('../lib/piano_tiles/assets/e.wav');
        return;
      case 3:
        player.play('../lib/piano_tiles/assets/f.wav');
        return;
    }
  }
}
