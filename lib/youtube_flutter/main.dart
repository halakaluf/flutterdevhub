...
import 'package:flutterdevhub/youtube_flutter/VideoItemModel.dart';
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  var videos = [
    VideoItemModel(
        ...
        "lib/youtube_flutter/assets/youtube_one.jpg"),
    VideoItemModel(
        "Hailee Steinfeld, Alesso - Let Me Go",
        "Hailee Steinfeld\n57M views.8 months ago",
        "lib/youtube_flutter/assets/youtube_two.jpg"),
    VideoItemModel(
        "Charlie Puth - Look At Me Now",
        "Lyricwood\n4.7M views.4 months ago",
        "lib/youtube_flutter/assets/youtube_three.jpg")
  ];
